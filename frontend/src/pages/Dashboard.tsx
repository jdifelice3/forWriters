    ...
    return (
        <Container maxWidth="lg" sx={{ pb: 1 }}>
            ...
            <Card variant="outlined" sx={{ height: "100%", maxWidth:"1000px",ml: "25px"  }}>
              ...
              <ul>
                <li>Preview, download, edit, or delete manuscripts.</li>
              ...
              <ul>
                ...
                <li>Members of a writing group can view the reading schedule and then sign up.</li>
                <li>The schedule will tell them how many open spots a reading has.</li>
             </ul>
